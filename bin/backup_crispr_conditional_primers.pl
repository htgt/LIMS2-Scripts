...
print OUTPUT "$header,LAL_seq,LAL_gc,LAL_tm,LAR_seq,LAR_gc,LAR_tm,RAL_seq,RAL_gc,RAL_tm,RAR_seq,RAR_gc,RAR_tm,\n";
...
while(<$fh>) {
    ...
    my $ra_chr_region_start = $ra_slice_region->start;
    ## $ra_chr_region_start

    my $ra_chr_region_end = $ra_slice_region->end;
    ## $ra_chr_region_end
    ...
    my $la_chr_region_start = $la_slice_region->start;
    ## $la_chr_region_start

    my $la_chr_region_end = $la_slice_region->end;
    ## $la_chr_region_end
...
my ($lal_seq, $lal_gc, $lal_tm, $lar_seq, $lar_gc, $lar_tm ) = ('','','','','','');
...
my ($ral_seq, $ral_gc, $ral_tm, $rar_seq, $rar_gc, $rar_tm ) = ('','','','','','');
...
print OUTPUT "$line,$lal_seq,$lal_gc,$lal_tm,$lar_seq,$lar_gc,$lar_tm,$ral_seq,$ral_gc,$ral_tm,$rar_seq,$rar_gc,$rar_tm\n";

print "$line,$lal_seq,$lal_gc,$lal_tm,$lar_seq,$lar_gc,$lar_tm,$ral_seq,$ral_gc,$ral_tm,$rar_seq,$rar_gc,$rar_tm\n";
