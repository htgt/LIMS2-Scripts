...
while(<$fh>) {
    ...
    my ( $gene_id, $marker_symbol, $assembly, $build, $species, $ensembl_gene_id, $ensembl_exon_id, $exon_size, $exon_rank, $canonical_transcript, $exon_start, $exon_end, $chr_name, $chr_strand, $ins_start, $ins_end, $ins_seq, $insertion_site, $split_exon_L , $split_exon_R ) =  split(',', $line);
